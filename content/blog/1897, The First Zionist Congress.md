...
head:
  meta:
    - name: 'keywords'
      content: 'Basel Kunstverein, Switzerland, 1998, First Zionist congress 1898, Zionism, Clegg & Guttmann'
    - name: 'robots'
    ...
    - name: 'description'
      content: 'The text first appeared in the as a press release for the Clegg & Guttmann show in the Basel Kunstverein - 100 Years to the first Zionist Congress'
    - name: 'og:title'
      content: 'This is an OpenGraph title'
---

## 1. The Exhibition: History and Reflection
...
* A **historical exhibition** centered on the pivotal event of the first Zionist Congress in June 1897.
* A **meditation on the concept of a historical show** itself.
...
## 2. On Curating Historical Shows
...
* Historical exhibitions must appeal to the **visual** and the **immediate** organization of material, different from a book presentation.
* However, we believe an object becomes **important the moment we make it the focus of attention**.
...
## 3. The First Zionist Congress: A European Event
...
## 4. Background: The Revolt Against Reason
...
* The Enlightenment held that the world was open to **rational understanding** and that reason could lead to a just government.
* It was in the name of **enlightened universalism** that the Jews were emancipated in Europe.
...
### The Rise of Anti-Semitism and the Culture of Denial
...
* The vast majority of West European Jews refused to acknowledge the gravity of anti-Semitism.
* Those who did often blamed themselves for not trying sincerely enough to **assimilate** and "lose their Jewish-ness."
* Attempts to "pass for non-Jews" were met with scorn by non-Jewish neighbors.

### Zionism as a "Realist" Movement
...
* Zionism was a **"realist" movement** aiming to counter the tendency among Jews to repress and obscure their perceptions.
* In their perception that anti-Semitism was ingrained, the Zionists also contributed to the erosion of the liberal democratic spirit and the "revolt against reason."

### Zionism's Twofold Aim
...
* A single person speaks the language of **personal misery**.
* When others join, a **collective entity is born**, and wretchedness gives way to collective **pride**.
...
### A Remark to Practitioners of Identity Politics
Zionist history is a case study that reminds newer movements of the **dangers inherent in identity politics**.

* Zionism started as a sincerely **Utopian solution** (Herzl thought it could apply to American blacks).
* Later, it helped the creation of a **new Palestinian nation** fighting for national rights on similar principles.
...
* **Assimilationism** repressed the awareness of one's appearance and did not produce a culture of portraiture.
* **Zionists** negated assimilationism, creating an immense awareness of the power of photography to create **new Jewish icons**, but concentrating on the visionary and mythical.
